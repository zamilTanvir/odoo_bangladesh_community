    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
      <Section className="pb-0">
        <h1 className="text-balance text-3xl font-semibold text-foreground sm:text-4xl">
          Odoo Functional Training (Bangladesh)
        </h1>
        <p className="mt-4 max-w-2xl text-sm text-muted sm:text-base">
          Build practical ERP skills for Sales, CRM, Purchase, Inventory, Accounting, Manufacturing, HR,
          Payroll, POS, and more.
        </p>
      </Section>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {topics.map((topic) => (
          ...
          >
            ...
            <div className="mt-5">
              <Link
                href={`/odoo-functional-training/${topic.slug}`}
