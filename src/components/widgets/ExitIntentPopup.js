...
export default function ExitIntentPopup() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end justify-center bg-black/40 p-4 sm:items-center">
      <div className="w-full max-w-lg rounded-[var(--radius-lg)] border border-foreground/10 bg-background p-6 shadow-[var(--shadow-soft)]">
        ...
        <div className="mt-5 flex gap-3">
          ...
          <Link
            ...
            className="flex h-11 flex-1 items-center justify-center rounded-full border border-foreground/15 bg-background text-sm font-medium text-foreground hover:bg-foreground/[0.03]"
          >
            Not now
          </Link>
        </div>
